...
import com.github.bigwolftime.convert.util.Base64Util;
import com.github.bigwolftime.convert.util.FileUtil;
...
public class FileToBase64 extends AnAction {
    ...
    private static final Logger LOGGER = Logger.getInstance(FileToBase64.class);
